...
import com.mindigo.admin_service.dto.request.CreateDoctorAccountRequest;
...
public interface AuthServiceClient {
    ...
    @PostMapping("/api/v1/auth/admin/create-doctor")
    ResponseEntity<ApiResponseClass<Void>> createDoctorAccount(
