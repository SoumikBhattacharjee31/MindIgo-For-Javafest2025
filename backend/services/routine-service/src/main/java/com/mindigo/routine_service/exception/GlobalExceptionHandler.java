...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RoutineAlreadyAssignedException.class)
    public ResponseEntity<ErrorResponse> handleRoutineAlreadyAssignedException(RoutineAlreadyAssignedException ex) {
        ErrorResponse error = new ErrorResponse(
