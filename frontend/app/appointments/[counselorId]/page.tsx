    ...
    const loadData = async () => {
      try {
        ...
        const counselorsResponse =
          await appointmentServiceApi.getMyAppointments(); // This will include counselor info
        const counselorData = counselorsResponse.data.data.find(
          (app: Appointment) => app.counselorId === counselorId
        );
        ...
        const datesResponse = await appointmentServiceApi.getAvailableDates(
          counselorId
        );
        ...
        const appointmentsResponse =
          await appointmentServiceApi.getMyAppointments();
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="text-gray-600">
              The counselor you're looking for doesn't exist.
            </p>
            <button
        ...
        <div className="mt-8 bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold">
              My Appointments with {counselor.name}
            </h2>
          </div>

          <div className="divide-y divide-gray-200">
            {myAppointments.filter((app) => app.counselorId === counselorId)
              .length > 0 ? (
              myAppointments
                          ...
                          userRole === "CLIENT" && (
                            <button
                              onClick={() => {
                                ...
                                toast.info(
                                  "Cancel functionality not implemented in this demo"
                                );
                              }}
