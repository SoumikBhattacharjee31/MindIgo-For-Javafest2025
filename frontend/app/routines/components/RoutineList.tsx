...
import { RoutineResponse, RoutineType } from "@/app/routines/types";
import {
  formatTime12Hour,
...
const RoutineList: React.FC<RoutineListProps> = ({
  ...
  const filteredRoutines = routines
    .filter((routine) => {
      ...
      const matchesType =
        filterType === "ALL" || routine.routineType === filterType;
            ...
            <div className="flex items-center space-x-2">
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${
                  routine.routineType === RoutineType.DAILY
              ...
              <span className="text-sm text-gray-500">
                ...
                {routine.activities.length === 1 ? "activity" : "activities"}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                value={filterType}
                onChange={(e) =>
                  setFilterType(e.target.value as RoutineType | "ALL")
                }
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                value={sortBy}
                onChange={(e) =>
                  setSortBy(e.target.value as "name" | "created" | "updated")
                }
                className="px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
