...
const RoutineForm: React.FC<RoutineFormProps> = ({
  ...
  const handleRoutineChange = (
    field: keyof CreateRoutineRequest,
    value: any
  ) => {
    setRoutine((prev) => ({
      ...prev,
  ...
  const updateActivity = (
    ...
    // Clear related errors
    setErrors((prev) =>
      prev.filter((error) => !error.field.includes(`activities[${index}]`))
    );
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              updateActivity(index, "activityType", e.target.value)
            }
        ...
        {routine.routineType === RoutineType.WEEKLY && (
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateActivity(index, "dayOfWeek", e.target.value)
              }
              className={`w-full p-2 border rounded-md ${
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            onChange={(e) =>
              updateActivity(index, "instructions", e.target.value)
            }
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium ${
                      activity.activityType === ActivityType.FOOD
                        ? "bg-green-100 text-green-800"
                        : activity.activityType === ActivityType.EXERCISE
                        ? "bg-blue-100 text-blue-800"
                        : activity.activityType === ActivityType.SLEEP
                        ? "bg-purple-100 text-purple-800"
                        : activity.activityType === ActivityType.MEDITATION
                ...
                <div className="text-sm text-gray-600">
                  ...
                  {routine.routineType === RoutineType.WEEKLY &&
                    activity.dayOfWeek && (
                      <span className="ml-2">
                        •{" "}
                        {activity.dayOfWeek.charAt(0) +
                          activity.dayOfWeek.slice(1).toLowerCase()}
                      </span>
                    )}
                </div>
        ...
        <div className="p-6">
          ...
          {showPreview ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {errors
                .filter((error) => error.field === "activities")
                .map((error, index) => (
                  <div
                    key={index}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleRoutineChange("routineType", e.target.value)
                    }
              ...
              <div>
                ...
                {routine.activities.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p>
                      No activities added yet. Click "Add Activity" to get
                      started.
                    </p>
                  </div>
                ) : (
