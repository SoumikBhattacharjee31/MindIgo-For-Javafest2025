...
export const meetingApi = {
  ...
  acceptMeetingRequest: (requestId) =>
    axios.put(`${API_BASE_URL}/counselor/requests/${requestId}/accept`, {}, axiosConfig),
  
  rejectMeetingRequest: (requestId, rejectionReason) =>
    axios.put(`${API_BASE_URL}/counselor/requests/${requestId}/reject`, 
      { rejectionReason }, axiosConfig),

  // User APIs
  createMeetingRequest: (counselorId, meetingType) =>
    axios.post(`${API_BASE_URL}/user/request`, 
      { counselorId, meetingType }, axiosConfig),
