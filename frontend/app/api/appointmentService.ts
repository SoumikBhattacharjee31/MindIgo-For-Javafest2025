...
export const appointmentApi = {
  ...
  createAvailability: (availabilityData) =>
    axios.post(`${API_BASE_URL}/appointments/availability`, availabilityData, axiosConfig),
  
  getMyAvailability: () =>
    axios.get(`${API_BASE_URL}/appointments/availability/my`, axiosConfig),
  
  getCounselorAvailability: (counselorId) =>
    axios.get(`${API_BASE_URL}/appointments/availability/counselor/${counselorId}`, axiosConfig),
  
  updateAvailability: (availabilityId, availabilityData) =>
    axios.put(`${API_BASE_URL}/appointments/availability/${availabilityId}`, availabilityData, axiosConfig),
  
  deleteAvailability: (availabilityId) =>
    axios.delete(`${API_BASE_URL}/appointments/availability/${availabilityId}`, axiosConfig),

  // Date-specific availability APIs
  createDateSpecificAvailability: (dateSpecificData) =>
    axios.post(`${API_BASE_URL}/appointments/availability/date-specific`, dateSpecificData, axiosConfig),
  
  getMyDateSpecificAvailability: () =>
    axios.get(`${API_BASE_URL}/appointments/availability/date-specific/my`, axiosConfig),
  
  getCounselorDateSpecificAvailability: (counselorId, date = null) =>
    axios.get(`${API_BASE_URL}/appointments/availability/date-specific/counselor/${counselorId}`, {
      ...axiosConfig,
      params: date ? { date } : {}
    }),
  
  updateDateSpecificAvailability: (availabilityId, dateSpecificData) =>
    axios.put(`${API_BASE_URL}/appointments/availability/date-specific/${availabilityId}`, dateSpecificData, axiosConfig),
  
  deleteDateSpecificAvailability: (availabilityId) =>
    axios.delete(`${API_BASE_URL}/appointments/availability/date-specific/${availabilityId}`, axiosConfig),
  ...
  updateCounselorSettings: (settingsData) =>
    axios.put(`${API_BASE_URL}/appointments/counselors/settings`, settingsData, axiosConfig),
};