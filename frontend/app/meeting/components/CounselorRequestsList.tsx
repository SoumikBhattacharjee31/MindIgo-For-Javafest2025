...
const CounselorRequestsList = () => {
  ...
  const [requestToReject, setRequestToReject] = useState<MeetingRequest | null>(
    null
  );
  const [selectedMeeting, setSelectedMeeting] = useState<MeetingRequest | null>(
    null
  );
  ...
  const handleRejectRequest = async () => {
    ...
    try {
      await meetingApi.rejectMeetingRequest(
        requestToReject.id,
        rejectionReason
      );
      await fetchRequests();
