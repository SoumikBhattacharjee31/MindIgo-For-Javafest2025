...
const UserMeetingRequest: React.FC<UserMeetingRequestProps> = ({
  counselors,
}) => {
  ...
  const handleSubmitRequest = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await meetingApi.createMeetingRequest(
        parseInt(selectedCounselor),
        meetingType
      );
          ...
          <div className="flex space-x-4">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) =>
                  setMeetingType(e.target.value === "AUDIO" ? "AUDIO" : "VIDEO")
                }
