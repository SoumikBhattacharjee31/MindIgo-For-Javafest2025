...
import { AlignJustify, User, Settings, LogOut, Bell, HelpCircle, BarChart3, House, Gamepad2 } from "lucide-react";
      ...
      >
        ...
        <User
          className={`w-6 h-6 transition-all duration-300 z-10 group-hover:scale-110 group-hover:rotate-12 ${
            isActive ? "text-violet-700 animate-pulse" : "text-indigo-500 group-hover:text-violet-600"
          }`}
        />
      </button>
