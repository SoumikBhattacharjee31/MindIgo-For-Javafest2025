...
class QuizErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    errorToast('Something went wrong with the quiz. Please try refreshing the page.');
  }
          ...
          <div className="max-w-md w-full">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                We encountered an unexpected error with the quiz. Please refresh the page and try again.
              </p>
