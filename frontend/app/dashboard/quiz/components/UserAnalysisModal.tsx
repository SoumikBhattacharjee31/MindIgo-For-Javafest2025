...
import { quizApi } from "@/app/dashboard/quiz/api/quizApi";
...
const UserAnalysisModal: React.FC<UserAnalysisModalProps> = ({
  ...
  const [analysisData, setAnalysisData] = useState<MoodAnalysisData | null>(
    null
  );
  ...
  const fetchAnalysisData = async () => {
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error ? err.message : "Failed to load analysis report";
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div
                  className={`border rounded-lg p-4 ${getRiskLevelColor(
                    analysisData.data.mood_analysis.risk_level
                  )}`}
                >
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <span
                      className={`px-2 py-1 rounded text-sm font-medium ${
                        analysisData.data.mood_analysis
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {analysisData.data.mood_analysis.dominant_emotions.map(
                    (emotion, index) => (
                      <span
                        key={index}
              ...
              <div>
                ...
                <div className="space-y-4">
                  {analysisData.data.mood_analysis.mood_indicators.map(
                    (indicator, index) => (
                      <div
                        key={index}
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <span
                              className={`px-3 py-1 rounded-full text-sm font-medium ${getIndicatorLevelColor(
                                indicator.level
                              )}`}
                            >
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {analysisData.data.mood_analysis.recommendations.map(
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <span>
                    ...
                    {analysisData.data.assessment_reliability}
                  </span>
                  <span>
                    <strong>Questions Analyzed:</strong>{" "}
                    {analysisData.data.total_questions}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
          <div className="text-sm text-gray-600">
            This analysis is based on your quiz responses and is for
