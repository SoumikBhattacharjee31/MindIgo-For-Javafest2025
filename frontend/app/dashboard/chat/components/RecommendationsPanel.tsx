...
import { Recommendation } from "@/app/dashboard/chat/dataType";
  ...
  const getUrgencyStyle = (urgency: string) => {
    switch (urgency) {
      case "immediate":
        return {
          container:
            "border-red-200/50 bg-gradient-to-br from-red-50/80 via-rose-50/60 to-pink-50/40 shadow-red-100/50",
          badge:
      ...
      case "high":
        return {
          container:
            "border-amber-200/50 bg-gradient-to-br from-amber-50/80 via-orange-50/60 to-yellow-50/40 shadow-amber-100/50",
          badge:
      ...
      case "medium":
        return {
          container:
            "border-blue-200/50 bg-gradient-to-br from-blue-50/80 via-indigo-50/60 to-purple-50/40 shadow-blue-100/50",
          badge:
      ...
      default:
        return {
          container:
            "border-emerald-200/50 bg-gradient-to-br from-emerald-50/80 via-teal-50/60 to-green-50/40 shadow-emerald-100/50",
          badge:
          ...
          <div className="text-center text-slate-500 flex items-center justify-center h-full">
            <div className="bg-gradient-to-br from-violet-50/80 via-purple-50/60 to-indigo-50/40 backdrop-blur-sm p-8 rounded-3xl border border-violet-100/50 shadow-lg">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                As we chat, I'll suggest helpful resources, activities, and
                support options tailored just for you.
              </p>
            </div>
          </div>
        ) : (
            ...
            {recommendations.length > 1 && (
              <div className="sticky top-0 bg-white/90 backdrop-blur-md p-3 rounded-xl border border-violet-200/50 mb-4 z-10 shadow-sm">
                <p className="text-xs text-violet-700 font-medium text-center">
                  Sorted by priority • {recommendations.length} recommendation
                ...
                >
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-slate-700 mb-3 leading-relaxed opacity-90">
                        {rec.reason}
                      </p>
                      <div
                        className={`text-xs px-3 py-2 rounded-full inline-block font-semibold backdrop-blur-sm ${styles.text}`}
                      >
