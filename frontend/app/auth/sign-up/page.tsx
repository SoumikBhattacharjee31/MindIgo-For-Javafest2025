...
import UserTypeSelector from "@/app/components/UserTypeSelector";
...
const SignUp = () => {
  ...
  const [verificationDocument, setVerificationDocument] = React.useState<
    File | undefined
  >();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (userType === "COUNSELOR") {
      if (!licenseNumber || !specialization || !verificationDocument) {
        errorToast(
          "Please fill in all counselor-specific fields and upload verification document"
        );
        return;
      }
    }
