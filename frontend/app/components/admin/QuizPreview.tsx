...
const QuizPreview: React.FC<QuizPreviewProps> = ({ quiz, onSaveQuiz, loading = false }) => {
          ...
          <div className="flex items-center space-x-4 mt-2">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex space-x-2">
                {Array.from(new Set(quiz.quizzes.map(q => q.type))).map(type => (
                  <span key={type}>
      ...
      {onSaveQuiz && (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <p className="text-xs text-purple-600 mt-2">
            Select the questions you want to include in the final quiz, then click save to create it.
          </p>
        </div>
      )}
              ...
              <div className="px-4 pb-4 border-t border-gray-100">
                <div className="mt-4">
                  ...
                  {question.type === 'scale' && question.scale_labels && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-700 mb-3">
                        Rating Scale ({question.scale_min} - {question.scale_max}):
                      </h4>
                  ...
                  {question.type === 'descriptive' && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-700 mb-3">Response Type:</h4>
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600">Open-ended text response</span>
                        </div>
                      </div>
                    </div>
                  )}
