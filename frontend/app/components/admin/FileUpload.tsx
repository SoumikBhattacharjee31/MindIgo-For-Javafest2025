    ...
    <div className="space-y-4 text-gray-900">
      ...
      >
        ...
        <div className="space-y-4">
          <div className={`mx-auto w-16 h-16 flex items-center justify-center rounded-full transition-colors ${
        ...
        {loading && (
          <div className="absolute bottom-4 left-4 right-4">
            ...
            <p className="text-xs text-purple-600 font-medium mt-1 text-center">Uploading file...</p>
          </div>
        )}
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• Clear and well-structured content works best for quiz generation</li>
          <li>• Ensure the document contains substantive content for meaningful questions</li>
        </ul>
      </div>
    </div>
  );
