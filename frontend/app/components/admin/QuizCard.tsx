    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-2">
              <h3 className="text-lg font-semibold text-gray-900">{quiz.quizCode}</h3>
            ...
            <p className="text-sm text-gray-500">
              Created: {new Date(quiz.questions[0]?.createdAt).toLocaleDateString()}
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-purple-600">{quiz.completedUsers.length}</p>
          ...
          <div className="border-t pt-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-medium text-gray-700">
                Completed by {quiz.completedUsers.length} user{quiz.completedUsers.length !== 1 ? 's' : ''}
              </h4>
              <button
          ...
          <div className="border-t pt-4">
            <div className="text-center text-gray-500">
              <svg className="w-8 h-8 mx-auto mb-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2 2v-5m16 0h-3m-13 0h3m-3 0l3-3m0 0l3 3M9 21v-4a2 2 0 012-2h2a2 2 0 012 2v4" />
              </svg>
