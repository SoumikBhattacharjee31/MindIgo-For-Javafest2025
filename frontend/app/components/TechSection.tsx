    ...
    return(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Secure, scalable, and reliable platform you can trust</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Advanced AI models provide personalized recommendations and insights
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Expert-Backed</h3>
              <p className="text-gray-600">
                All content and features are reviewed and approved by mental health professionals
              </p>
            </div>
          </div>
        </div>
