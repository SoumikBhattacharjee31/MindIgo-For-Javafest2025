...
import { REPORT_REASONS } from '../../api/discussionService';
...
const ReportModal = ({ isOpen, onClose, type, onSubmit }: ReportModalProps) => {
  ...
  const reportReasons = [
    { value: REPORT_REASONS.SPAM, label: 'Spam', description: 'Repetitive, unwanted, or promotional content' },
    { value: REPORT_REASONS.HARASSMENT, label: 'Harassment', description: 'Bullying, threats, or targeted abuse' },
    { value: REPORT_REASONS.INAPPROPRIATE_CONTENT, label: 'Inappropriate Content', description: 'Content that violates community standards' },
    { value: REPORT_REASONS.MISINFORMATION, label: 'Misinformation', description: 'False or misleading information' },
    { value: REPORT_REASONS.HATE_SPEECH, label: 'Hate Speech', description: 'Content that promotes hatred or discrimination' },
    { value: REPORT_REASONS.OTHER, label: 'Other', description: 'Another reason not listed above' }
  ];
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-4">
              Help us understand what's happening with this {type}. Your report will be reviewed by our moderation team.
            </p>
          </div>
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Additional details {selectedReason === REPORT_REASONS.OTHER ? '*' : '(Optional)'}
            </label>
            <textarea
              value={description}
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Please only submit reports for content that violates our community guidelines. 
