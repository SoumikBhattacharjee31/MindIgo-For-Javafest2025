...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      id={`feature-${index}`}
      data-animate
      className={`bg-gradient-to-br ${gradient} rounded-2xl p-8 hover:shadow-xl transition-all duration-700 transform ${
        isVisible
    ...
    >
      {/* Icon with Animation */}
      <div
        className={`${iconBg} rounded-full p-3 w-fit mb-6 transform transition-all duration-500 ${
