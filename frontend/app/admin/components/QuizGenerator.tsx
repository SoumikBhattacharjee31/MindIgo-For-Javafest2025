...
const QuizGenerator: React.FC<QuizGeneratorProps> = ({
  ...
  const difficultyOptions = [
    ...
    },
    {
      value: "medium",
      label: "Medium",
      description: "Moderate analysis needed",
    },
    {
      value: "hard",
      label: "Hard",
      description: "Deep comprehension required",
    },
  ];
  ...
  return (
    <form
      ...
      className={`space-y-6 transition-opacity ${loading ? "opacity-75" : ""}`}
    >
      {/* Selected File Info */}
      ...
      <div>
        ...
        <div className="flex items-center space-x-4">
          ...
          />
          <div
            className={`flex items-center justify-center w-16 h-10 rounded-lg font-semibold transition-colors ${
              loading
          ...
          {questionTypeOptions.map((option) => (
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleQuestionTypeChange(option.value, e.target.checked)
                }
                disabled={loading}
          ...
          {assessmentAreaOptions.map((option) => (
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleAssessmentAreaChange(option.value, e.target.checked)
                }
                disabled={loading}
                className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 disabled:opacity-50"
              />
      ...
      <div className="pt-4 border-t border-gray-200">
        ...
        <p className="text-xs text-gray-500 text-center mt-2">
          This may take a few moments to process your document and generate
          questions
        </p>
      </div>
    </form>
