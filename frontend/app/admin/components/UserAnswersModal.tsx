...
const UserAnswersModal: React.FC<UserAnswersModalProps> = ({
  ...
  const [analysisResponse, setAnalysisResponse] =
    useState<MoodAnalysisResponse | null>(null);
  ...
  const renderAnswer = (
    question: UserQuizReport["quizzes"][0],
    answer: string,
    index: number
  ) => {
  ...
  const uploadAnalysisReport = async () => {
    ...
    try {
      ...
      formData.append(
        "file",
        analysisBlob,
        `mood_analysis_${userId}_${Date.now()}.json`
      );
  ...
  const confirmAnalysisLinkUpdate = async () => {
    console.log("confirmAnalysisLinkUpdate called", {
      uploadedReportUrl,
      userId,
      quizCode,
    });
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Generated analysis for User ID: {userId}
                </p>
              </div>
              <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-blue-800">
                    {analysisResponse.data.mood_analysis.overall_mood_state}
                  </p>
                </div>
                ...
                <div
                  className={`border rounded-lg p-4 ${
                    analysisResponse.data.mood_analysis.risk_level === "high"
                      ...
                      : analysisResponse.data.mood_analysis.risk_level ===
                        "moderate"
                ...
                >
                  ...
                  >
                    ...
                    {analysisResponse.data.mood_analysis
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {analysisResponse.data.mood_analysis.mood_indicators.map(
                      (indicator, index) => (
                        <div
                          key={index}
                ...
                <div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <ul className="list-disc list-inside text-green-800 space-y-2">
                      {analysisResponse.data.mood_analysis.recommendations.map(
                        (rec, index) => (
                          <li key={index}>{rec}</li>
                        )
                      )}
            ...
            <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
              <div className="flex items-center space-x-2">
                <span className="text-sm text-gray-600">
                  ...
                  <strong>
                    {analysisResponse.data.assessment_reliability}
                  </strong>
                </span>
                <span className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Analysis report has been uploaded successfully
                </p>
              </div>
              <button
            ...
            <div className="p-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-green-700 text-sm">
                  The mood analysis report has been uploaded to the reports
                  system.
                </p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-800 text-sm">
                  <strong>Next Step:</strong> Would you like to update the
                  analysis link for this user with the uploaded report URL? This
                  will link the user's quiz responses to their detailed mood
                  analysis report.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center space-x-3">
              ...
              {!showAnalysisForm ? (
                ...
                <form
                  onSubmit={handleSubmitAnalysisLink}
